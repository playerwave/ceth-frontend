...
const ActivityTimeSection: React.FC<Props> = ({
  ...
  return (
    ...
    //             <DateTimePicker
    //               className="w-77.5"
    //               minDate={formData.end_register_date ? dayjs(formData.end_register_date) : dayjs()}
    //               value={
    ...
    //                         'hour'
    //                       ) < 1 ||
    //                       // ✅ เพิ่มการตรวจสอบ: วันที่และเวลาต้องไม่ตรงกัน
    //                       dayjs(formData.start_activity_date)?.isSame(
    ...
    //             <DateTimePicker
    //               className="w-77.5"
    //               minDate={formData.start_activity_date ? dayjs(formData.start_activity_date) : dayjs()}
    //               value={
    ...
    //                   helperText:
    //                     formData.activity_status === "Public" && formData.end_activity_date && formData.start_activity_date
    //                       ? (formData.start_activity_date &&
    //                           dayjs(formData.end_activity_date)?.isBefore(
    //                             dayjs(formData.start_activity_date),
    //                           )
      ...
      <div className="w-1/2">
        <div className="flex flex-col">
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            <DateTimePicker
              className="w-77.5"
              minDate={formData.end_register_date ? dayjs(formData.end_register_date) : dayjs().add(1, "day")}
              value={
                formData.start_activity_date
                  ? dayjs(formData.start_activity_date)
                  : null
