// components/AdminActivityForm/ActivityTimeSection.update.tsx
...
const ActivityTimeSectionUpdate: React.FC<Props> = ({
  formData,
  ...
  // ✅ ตรวจสอบเงื่อนไขสำหรับ update mode
  const startBeforeOrOnEndReg = !!(mustBeNextDay && startAct && endReg && !startAct.startOf("day").isAfter(endReg.startOf("day")));
...
export default ActivityTimeSectionUpdate;
